...
use Gtd\ClasesWs\TvRefrescaServicioCorp;
 ...
 * @Param $servicios los servicios que se desean actualizar
 *        Varchar(200)
 *        Servicios del cliente con fecha de alta y fecha de baja
 *        Ejemplo: '10-07-2014',,79|1|35
 *
 * @return Struct
 */
...
)
{
    ...
    $obj = new TvRefrescaServicioCorp($info);
