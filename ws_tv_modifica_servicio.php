...
/**
 * Web Service de Modificacion de servicio para Minerva y VO
 *
 * Este Webservice esta destinado para modificar el servicio de GTD y Telsur
...
use Gtd\ClasesWs\TvModificaServicio;
...
$wsURL = $config->urlWsdl . $config->folderWsdl . "ws_tv_modifica_servicio.php";
$server = new NusoapServer();
// $server->debug_flag=false;
$server->configurewsdl('ws_tv_modifica_servicio', $wsURL);
...
function ws_tv_modifica_servicio(
    $instanciasubcuenta,
    $macs,
    $series,
    $planes,
...
)
{
    ...
    // Webserive a la Clase que modifica el servicio
    $info = array(
    ...
    // Se instancia la clase de TvModificaServicio
    $obj = new TvModificaServicio($info);
    // Se llama metodo que modifica el servicio
    $resultado = $obj->modificaServicio();
...
//Para el metodo ws_tv_modifica_servicio
$parameters = array(
...
$server->register(
    'ws_tv_modifica_servicio', //nombre de la funcion
