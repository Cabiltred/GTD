...
/**
 * Class Ultimate MySQL Wrapper Class
 *
 * Esta clase permite realizar operaciones a la bse de datos de Mysql
 *
 *                                  ╔═╗      ╔═╗
 *                                ╔═╝ ╚═╗    ║ ║
 *                          ╔════╗╚╗  ╔═╝ ╔══╝ ║
 ...
 * @author Jeff L. Williams <email@email.com>
...
class Mysql
{
     ...
     */
    static private function BuildSQLColumns($columns,
                                            $addQuotes = TRUE,
                                            $showAlias = TRUE)
    {
        if ($addQuotes) {
     ...
     *                          values must be SQL ready (i.e. quotes around
     *                          strings, formatted dates, ect)
     * @param array/string $columns (Optional) The column or
     *                      list of columns to select
     * @param array/string $sortColumns (Optional) Column or
     *                      list of columns to sort by
     * @param boolean $sortAscending (Optional) TRUE for ascending;
     *                      FALSE for descending This only works if
     *                      $sortColumns are specified
     * @param integer/string $limit (Optional) The limit of rows to return
     * @return string Returns a SQL SELECT statement
     */
    static public function BuildSQLSelect($tableName,
                                          $whereArray = NULL,
                                          $columns = NULL,
                                          $sortColumns = NULL,
                                          $sortAscending = TRUE,
     ...
     */
    static public function BuildSQLUpdate($tableName,
                                          $valuesArray,
                                          $whereArray = NULL)
    {
        $sql = "";
   ...
   /**
     ...
     *
     * @param boolean $showCount (Optional) TRUE if you want to show the row
     *                      count, FALSE if you do not want to show the count
     * @param string $styleTable (Optional) Style information for the table
     * @param string $styleHeader (Optional) Style information  the header row
     ...
     */
    public function GetHTML($showCount = TRUE,
                            $styleTable = NULL,
                            $styleHeader = NULL,
                            $styleData = NULL)
    {
    ...
    */
     ...
     */
    static public function SQLBooleanValue($value,
                                           $TRUEValue,
                                           $falseValue,
                                           $datatype = self::SQLVALUE_TEXT)
    {
