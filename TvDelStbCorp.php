...
/**
 * Class Baja de deco de Servicio de Televisión
 *
 * Esta clase permite realizar el proceso de Baja de Deco de un
...
class TvDelStbCorp
{
     ...
     * @return struct
     */
    public function delStb()
    {
        $return = [];
        // Almacena Log de seguimiento
        $this->_util->setLog(
            $this->_config->urlLog,
            "B A J A   D E   D E C O   C O R P",
            "MEDIADOR",
        ...
        if ($validaDb && $validaDbMinerva) {
            ...
            if ($validaParametros === TRUE) {
                ...
                if ($this->_return["default"]["status"] !== FALSE) {
                    ...
                    $this->_util->setLog(
                        $this->_config->urlLog,
                        "B A J A   D E   D E C O   S E R V I C I O   C O R P",
                        "MEDIADOR",
     ...
     * @return void
     */
    private function _delStbMinerva()
    {
        $return = [];
        $ws = new Ws();
        ...
        if ($rsPlataforma === TRUE) {
            ...
            if ($rsVAlidaUrl === TRUE) {
                ...
                if ($validaPrepara) {
                    ...
                    $return = $this->setDelStbMinerva($ws, $this->_aux);
                }
            } else {
     ...
     * @return void
     */
    public function setDelStbMinerva($ws, $info)
    {
        $return         = [];
     ...
     * @return void
     */
    private function _setDelStbVo($vo, $info)
    {
        $return   = [];
        $objSql = $this->_sqlMediador;
