...
use Gtd\ClasesWs\TvBajaServicioCorp;
...
$wsURL = $config->urlWsdl . $config->folderWsdl . "ws_tv_baja_servicio_corp.php";
$server = new NusoapServer();
// $server->debug_flag=false;
$server->configurewsdl('ws_tv_baja_servicio_corp', $wsURL);
 ...
 *        Varchar(100)
 *        Instancia Sicret
 *        EJemplo: TV10000R12345
 *
 * @return Struct
 */

function ws_tv_baja_servicio($instancia)
{
    ...
    $obj = new TvBajaServicioCorp($info);
